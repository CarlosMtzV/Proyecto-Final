...
namespace FinalProyect
{
    public partial class Form1 : Form
    {
        ...
        private void UpdateDataGridView()
        {
            ...
            if (students.Count > dataGridViewStudents.Columns.Count)
            {
                for (int i = dataGridViewStudents.Columns.Count; i < students.Count; i++)
                {
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            if (dataGridViewStudents.SelectedRows.Count > 0)
            {
                ...
                foreach (DataGridViewRow row in dataGridViewStudents.SelectedRows)
                {
                    ...
                    students.RemoveAll(s => s.RegistrationNumber == registrationNumber);
